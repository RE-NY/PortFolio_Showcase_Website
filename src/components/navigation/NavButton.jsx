import { Home, Palette, User, Github, Linkedin, Code, Bomb, Database, NotebookText} from 'lucide-react'
...
const getIcon = (icon) => {
    switch (icon) {
        ...
        case 'kaggle':
            return <Database className='w-full h-auto' strokeWidth={1.5} />
        case 'resume':
            return <NotebookText className='w-full h-auto' strokeWidth={1.5} />
        
        default:
            return <Bomb className='w-full h-auto' strokeWidth={1.5} />
    }
}
